...
export function TerminatedDisplayScreen() {
  const terminatedData = useDisplayStore(state => state.terminatedData);
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-[var(--color-surface)] py-12 px-8 sm:px-12 md:px-16 overflow-y-auto">
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="mb-10 bg-amber-100 border border-amber-300 text-amber-900 px-8 py-4 rounded-3xl w-full max-w-2xl shadow-sm text-center">
          <span className="text-4xl block mb-2">🛑</span>
          <p className="font-bold text-2xl">This quiz was ended early by the host.</p>
        </div>
